            ...
            <ThemeText>
              ...
              >
                <div className=" flex flex-col text-end justify-end gap-4 lg:gap-6 2xl:gap-8 h-">
                  <h1 className=" font-normal text-xl lg:text-[29px] 2xl:text-[42px] tracking-[0.2em] text-right px-2">
                    {"Let's do"}
                  </h1>
                  <h1 className="font-normal text-7xl lg:text-[115px] 2xl:text-[128px] tracking-widest text-end ">
                    this
                  </h1>
                </div>
