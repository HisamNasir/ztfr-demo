...
const Signup = () => {
  ...
  return (
    <div className="relative h-screen flex items-center transition-all duration-500">
      ...
      {/* centert --------------------------------------------- */}
      <div className="sm:flex py-[12px] px-[35px] sm:px-[50px] lg:pr-[60px] xl:py-[24px] gap-8 justify-center items-center w-full">
        <div className="max-sm:hidden max-lg:space-y-2 h-full flex flex-col justify-center">
          <Image
            alt=" "
            className="hidden px-4 max-lg:block h-auto w-[180px] md:w-[200px] "
            width={559}
            height={400}
            src={TransferImg}
          />
          <Image
            className=" w-full h-auto lg:w-[400px] 2xl:h-[400px] 2xl:w-[559px] "
            alt=""
            width={559}
            height={400}
            src={SingUpImage}
        ...
        <div className="hidden lg:flex justify-center  ">
          <Image
            alt=" "
            className=" w-full h-auto lg:w-[200px]  2xl:w-[354px] mx-[14px]"
            width={559}
            height={400}
            src={TransferImg}
          />
      ...
      <div className="px-[20px] py-[10px] 2xl:px-[50px] 2xl:py-[24px]  absolute max-sm:top-6 sm:bottom-16 2xl:bottom-24">
        <button onClick={goBack} className=" ">
          <Image
            className="h-auto w-5 md:w-6 lg:w-[30px]"
            src={BackArrow}
            alt=""
            width={30}
            height={21}
