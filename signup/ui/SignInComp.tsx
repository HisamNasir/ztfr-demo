  ...
  return (
    <form className='space-y-[10px] font-normal 2xl:space-y-[21px] w-full sm: lg:w-[350px] 2xl:w-[450px] max-h-[458px]'>
      <input
        placeholder="EMAIL"
        type='email'
        className='flex items-center h-[38px] md:h-[44px] 2xl:h-[63px] placeholder-black font-normal  outline outline-gray-300 outline-1  rounded-lg w-full p-3  lg:w-[350px] 2xl:w-[450px] tracking-wider bg-white justify-between px-[22px] text-[10px] lg:text-xs 2xl:text-lg' 
