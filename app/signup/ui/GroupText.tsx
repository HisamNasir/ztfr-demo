    ...
    return (
        <div className="hidden lg:flex  [word-spacing:1vw] tracking-[0.2em] flex-col flex-wrap w-full ">
            ...
            <div className="flex py-1 word-spacing:20px] ">
                ...
                <div className='relative flex md:w-[100px] lg:w-[120px] xl:w-[147px] mx-4'>
            ...
            <p className="text-[8px] xl:text-[9px] pt-2 2xl:text-sm [word-spacing:2px] tracking-[0.1em] ">ADVANCED AES 254-BIT ENCRYPTION</p>
        </div>
    );
};
