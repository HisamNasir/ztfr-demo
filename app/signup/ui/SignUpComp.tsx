...
<div className='sm:max-w-[450px] space-y-3 2xl:space-y-4 '>

      <input
        className='flex items-center lg:h-[50px] 2xl:h-[63px] outline outline-gray-300 outline-2  rounded-lg w-full max-w-[450px] p-3 tracking-wider bg-white justify-between px-8 text-sm 2xl:text-lg' 
        placeholder="EMAIL"
        type='email'
        value={email}
      ...
      />
      <input
        className='flex items-center lg:h-[50px] 2xl:h-[63px] outline outline-gray-300 outline-2  rounded-lg w-full p-3 max-w-[450px]  tracking-wider bg-white justify-between px-8 text-sm 2xl:text-lg' 
        type="text"
