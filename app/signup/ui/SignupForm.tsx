...
const SignupForm = () => {
  ...
  return (
    <div className='text-center p-2 max-md:px-10 flex flex-col w-full max-w-[554px]'>
      <div className='flex justify-between px-8 pb-3 text-sm w-full max-w-[450px] '>
        <button
      ...
      <button className='flex items-center outline outline-gray-300 outline-2  rounded-lg w-full p-2 max-w-[450px] xl:h-[63px] tracking-wider bg-white justify-between px-8 text-xs md:text-sm' 
    ...
    <div className='flex justify-center my-1 xl:my-2 text-2xl 2xl:text-3xl max-w-[450px]  text-[#BE9F56]'>or</div>
