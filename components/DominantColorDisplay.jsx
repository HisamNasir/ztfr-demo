...
const DominantColorDisplay = () => {
  ...
  return (
    <div
      className="dominant-color-display p-2"
    ...
    >
      ...
      {closestColorCombination && (
        <p>
          ...
          <span
            style={{
              backgroundColor: closestColorCombination.bgColor,
              color: closestColorCombination.textColor,
            }}
          >
            {closestColorCombination.bgColor} (
            {closestColorCombination.textColor})
          </span>
        </p>
      )}
    </div>
